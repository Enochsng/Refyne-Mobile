-- Alternative Database Setup Script - Run each section separately if needed
-- Run this script in your Supabase SQL Editor

-- Step 1: Create coach_connect_accounts table
...
-- Step 3: Create payment_transfers table
...
-- Step 5: Create messages table (without foreign key first)
